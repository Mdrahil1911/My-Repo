...
WebUI.setText(findTestObject('Object Repository/Page_OBORTECH - Admin Login/input_Welcome Back_username'), 'obortech')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OBORTECH - Admin Login/input_Welcome Back_password'), 'se//74IT7ufqnxLE0o0JPg==')
